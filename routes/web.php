...
//    Route::post('products/remove_expiry/{id}', 'ProductController@send_remove_damage');
    ...
    Route::post('user/check-password/{id}', 'AdminController@checkPassword')->name('admin.checkPassword');
    Route::post('user/check-admin-password/{id}', 'AdminController@checkAdminPassword');
    Route::get('user/get-dropdown', 'AdminController@getDropdown');
    Route::get('user/get-profile', 'AdminController@getProfile');
    Route::put('user/update-profile', 'AdminController@updateProfile');
    ...
    Route::group(['prefix' => 'hrm'], function () {
        ...
        Route::get('get-same-jobs-employee-details/{id}', 'EmployeeController@getSameJobEmployeeDetails');
    ...
    Route::get('cash-in-adjustment/get-cash-details/{admin_id}', 'CashInAdjustmentController@getCashDetails');
    Route::resource('cash-in-adjustment', CashInAdjustmentController::class);
    Route::get('cash-out-adjustment/get-cash-details/{admin_id}', 'CashOutAdjustmentController@getCashDetails');
