...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('products-class', [ProductClassController::class, 'index']);
    Route::post('products-class', [ProductClassController::class, 'store']);
    Route::put('products-class/{id}', [ProductClassController::class, 'update']);
    Route::delete('products-class/{id}', [ProductClassController::class, 'destroy']);
