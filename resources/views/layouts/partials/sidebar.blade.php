    ...
    <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#product" aria-expanded="false"
                            ...
                            <ul id="product"
                                ...
                                @can('product_module.barcode.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'barcode' && request()->segment(2) == 'print-barcode') ) active @endif">
                                        <a
                                            href="{{ action('BarcodeController@create') }}">{{ __('lang.print_barcode') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                ...
                @endif
                {{--                TODO permissions --}}
                <li class="side_main_menu_link"><a class="link" href="#manufacturings" aria-expanded="false"
                        data-toggle="collapse"> <i
                    ...
                    <ul id="manufacturings"
                        ...
                        <li class="@if (request()->segment(1) == 'manufacturers' && empty(request()->segment(2))) active @endif">
                        ...
                        <li class="@if (request()->segment(1) == 'email' && empty(request()->segment(2))) active @endif">
                            <a
                                href="{{ action('ManufacturingController@index', ['process']) }}">{{ __('lang.processed') }}</a>
                        </li>
                    </ul>
                </li>
                ...
                @if (session('system_mode') == 'restaurant' || session('system_mode') == 'garments' || session('system_mode') == 'pos')
                    @if (!empty($module_settings['raw_material_module']))
                        @if (auth()->user()->can('raw_material_module.raw_material.create_and_edit') ||
                            ...
                            <li class="side_main_menu_link"><a class="link" href="#raw_material" aria-expanded="false"
                                    data-toggle="collapse"> <i
                                ...
                                <ul id="raw_material"
                                    ...
                                    @can('raw_material_module.raw_material.create_and_edit')
                                        <li class="@if (request()->segment(1) == 'raw-material' && request()->segment(2) == 'create') ) active @endif">
                                            <a
                                                href="{{ action('RawMaterialController@create') }}">{{ __('lang.add_new_raw_material') }}</a>
                                        </li>
                                    @endcan
                                    @can('raw_material_module.raw_material.view')
                                        <li class="@if (request()->segment(1) == 'raw-material' && empty(request()->segment(2))) active @endif">
                                            <a
                                    ...
                                    @can('raw_material_module.consumption.create_and_edit')
                                        <li class="@if (request()->segment(1) == 'consumption' && request()->segment(2) == 'create') ) active @endif">
                                            <a
                                                href="{{ action('ConsumptionController@create') }}">{{ __('lang.add_manual_consumption') }}</a>
                                        </li>
                                    @endcan
                                    @can('raw_material_module.consumption.create_and_edit')
                                        <li class="@if (request()->segment(1) == 'consumption' && empty(request()->segment(2))) active @endif">
                                            <a
                                    ...
                                    @can('raw_material_module.add_stock_for_raw_material.create_and_edit')
                                        <li class="@if (request()->segment(1) == 'raw-material' &&
                                                request()->segment(2) == 'add-stock' &&
                                                request()->segment(3) == 'create') active @endif">
                                            <a
                                    ...
                                    @can('raw_material_module.add_stock_for_raw_material.view')
                                        <li class="@if (request()->segment(1) == 'raw-material' && request()->segment(2) == 'add-stock' && empty(request()->segment(3))) active @endif">
                                            <a
                                    ...
                                    @can('raw_material_module.remove_stock.create_and_edit')
                                        <li class="@if (request()->segment(1) == 'raw-materials' &&
                                                request()->segment(2) == 'remove-stock' &&
                                                request()->segment(3) == 'create') active @endif">
                                            <a href="/raw-materials/remove-stock/create">{{ __('lang.remove_stock') }}</a>
                                        </li>
                                    @endcan
                                    @can('raw_material_module.remove_stock.create_and_edit')
                                        <li class="@if (request()->segment(1) == 'raw-materials' && request()->segment(2) == 'remove-stock' && empty(request()->segment(3))) active @endif">
                                            <a
                                                href="/raw-materials/remove-stock/index">{{ __('lang.view_all_remove_stock') }}</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('raw_material_module.transfer.view')
                                        <li class="@if (request()->segment(1) == 'raw-materials' && request()->segment(2) == 'transfer' && empty(request()->segment(2))) active @endif">
                                            <a
                                    ...
                                    @can('raw_material_module.internal_stock_request.create_and_edit')
                                        <li class="@if (request()->segment(1) == 'raw-materials' &&
                                                request()->segment(2) == 'internal-stock-request' &&
                                                request()->segment(3) == 'create') active @endif">
                                            <a
                                    ...
                                    @can('raw_material_module.internal_stock_return.create_and_edit')
                                        <li class="@if (request()->segment(1) == 'raw-materials' &&
                                                request()->segment(2) == 'internal-stock-return' &&
                                                request()->segment(3) == 'create') active @endif">
                                            <a
                                    ...
                                    @can('raw_material_module.internal_stock_return.view')
                                        <li class="@if (request()->segment(1) == 'raw-materials' &&
                                                request()->segment(2) == 'internal-stock-return' &&
                                                empty(request()->segment(2))) active @endif">
                                            <a
                ...
                @if (!empty($module_settings['purchase_order']))
                    @if (auth()->user()->can('purchase_order.draft_purchase_order.view') ||
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#purchase_order" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="purchase_order"
                                ...
                                @can('purchase_order.draft_purchase_order.view')
                                    <li class="@if (request()->segment(1) == 'purchase-order' && request()->segment(2) == 'draft-purchase-order') active @endif">
                                        <a
                                ...
                                @can('purchase_order.purchase_order.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'purchase-order' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('PurchaseOrderController@create') }}">{{ __('lang.create_new_purchase_order') }}</a>
                                    </li>
                                @endcan
                                @can('purchase_order.purchase_order.view')
                                    <li class="@if (request()->segment(1) == 'purchase-order' && empty(request()->segment(2))) active @endif">
                                        <a
                                ...
                                @if (session('system_mode') != 'restaurant')
                                    @can('purchase_order.import.view')
                                        <li class="@if (request()->segment(1) == 'purchase-order' && request()->segment(2) == 'import') active @endif">
                                            <a
                ...
                @if (!empty($module_settings['stock']))
                    @if (auth()->user()->can('stock.add_stock.view') ||
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#stock" aria-expanded="false"
                                data-toggle="collapse">
                                <i class="dripicons-basket"></i><span>{{ __('lang.stock') }}</span><span></a>
                            <ul id="stock"
                                class="collapse list-unstyled @if (in_array(request()->segment(1), [
                                        'add-stock',
                                        'remove-stock',
                                        'transfer',
                                ...
                                @endcan
                                @can('stock.add_stock.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'add-stock' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('AddStockController@create') }}">{{ __('lang.add_new_stock') }}</a>
                                    </li>
                                @endcan
                                @can('stock.add_stock.view')
                                    <li class="@if (request()->segment(1) == 'add-stock' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('AddStockController@index') }}">{{ __('lang.view_all_added_stocks') }}</a>
                                    </li>
                                @endcan
                                @can('stock.remove_stock.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'remove-stock' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('RemoveStockController@create') }}">{{ __('lang.remove_stock') }}</a>
                                    </li>
                                @endcan
                                @can('stock.remove_stock.view')
                                    <li class="@if (request()->segment(1) == 'remove-stock' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('RemoveStockController@index') }}">{{ __('lang.view_all_remove_stock') }}</a>
                                    </li>
                                @endcan

                                @can('stock.remove_stock.view')
                                    <li class="@if (request()->segment(1) == 'remove-stock' && request()->segment(2) == 'get-compensated') active @endif">
                                        <a
                                            href="{{ action('RemoveStockController@getCompensated') }}">{{ __('lang.compensated_from_supplier') }}</a>
                                    </li>
                                @endcan
                                @can('stock.transfer.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'transfer' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('TransferController@create') }}">{{ __('lang.add_a_transfer') }}</a>
                                    </li>
                                @endcan
                                @can('stock.transfer.view')
                                    <li class="@if (request()->segment(1) == 'transfer' && empty(request()->segment(2))) active @endif">
                                        <a
                                ...
                                @can('stock.internal_stock_request.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'internal-stock-request' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="/internal-stock-request/create">{{ __('lang.internal_stock_request') }}</a>
                                    </li>
                                @endcan
                                @can('stock.internal_stock_return.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'internal-stock-return' && request()->segment(2) == 'create') active @endif">
                                        <a href="/internal-stock-return/create">{{ __('lang.internal_stock_return') }}</a>
                                    </li>
                                @endcan
                                @can('stock.internal_stock_return.view')
                                    <li class="@if (request()->segment(1) == 'internal-stock-return' && empty(request()->segment(2))) active @endif">
                                        <a href="/internal-stock-return">{{ __('lang.return_requests_report') }}</a>
                                    </li>
                                @endcan
                                @can('stock.import.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'add-stock' && request()->segment(2) == 'get-import') active @endif">
                                        <a
                                            href="{{ action('AddStockController@getImport') }}">{{ __('lang.import_add_stock') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                            ...
                            <li class="side_main_menu_link"><a class="link" href="#quotation_for_customers"
                                ...
                                <ul id="quotation_for_customers"
                                    ...
                                    @can('quotation_for_customers.quotation.create_and_edit')
                                        <li class="@if (request()->segment(1) == 'quotation' && request()->segment(2) == 'create') active @endif">
                                            <a
                                                href="{{ action('QuotationController@create') }}">{{ __('lang.create_quotation') }}</a>
                                        </li>
                                    @endcan
                                    @can('quotation_for_customers.quotation.view')
                                        <li class="@if (request()->segment(1) == 'quotation' && empty(request()->segment(2))) active @endif">
                                            <a
                                                href="{{ action('QuotationController@index') }}">{{ __('lang.quotation_list') }}</a>
                                        </li>
                                    @endcan
                                    @can('quotation_for_customers.quotation.view')
                                        <li class="@if (request()->segment(1) == 'quotation' && request()->segment(2) == 'view-all-invoices') active @endif">
                                            <a
                ...
                @if (!empty($module_settings['sale']))
                    @if (auth()->user()->can('sale.pos.create_and_edit') || auth()->user()->can('sale.pos.view'))
                        <li class="side_main_menu_link"><a class="link" href="#sale" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="sale"
                                ...
                                @can('sale.pos.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'pos' && request()->segment(2) == 'create') active @endif">
                                        <a href="{{ action('SellPosController@create') }}">{{ __('lang.pos') }}</a>
                                    </li>
                                @endcan
                                @can('sale.pos.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'sale' && request()->segment(2) == 'create') active @endif">
                                        <a href="{{ action('SellController@create') }}">{{ __('lang.add_sales') }}</a>
                                    </li>
                                @endcan
                                @can('sale.delivery_list.view')
                                    <li class="@if (request()->segment(1) == 'sale' && request()->segment(2) == 'get-delivery-list') active @endif">
                                        <a
                                            href="{{ action('SellController@getDeliveryList') }}">{{ __('lang.delivery_list') }}</a>
                                    </li>
                                @endcan
                                @can('sale.import.view')
                                    <li class="@if (request()->segment(1) == 'sale' && request()->segment(2) == 'get-import') active @endif">
                                        <a
                                            href="{{ action('SellController@getImport') }}">{{ __('lang.import_sale') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                ...
                @if (!empty($module_settings['quotation_for_customers']))
                    @if (auth()->user()->can('return.sell_return.view') ||
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#return" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="return"
                                ...
                                @can('return.sell_return.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'sale-return' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('SellReturnController@index') }}">{{ __('lang.view_all_return_sales') }}</a>
                                    </li>
                                @endcan
                                @can('return.purchase_return.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'purchase-return' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('PurchaseReturnController@create') }}">{{ __('lang.return_purchase') }}</a>
                                    </li>
                                @endcan
                                @can('return.purchase_return.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'purchase-return' && empty(request()->segment(2))) active @endif">
                                        <a
                ...
                @if (!empty($module_settings['expense']))
                    @if (auth()->user()->can('expense.expenses.create_and_edit') ||
                            ...
                            auth()->user()->can('expense.expense_beneficiaries.view'))
                        <li class="side_main_menu_link"><a class="link" href="#expense" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="expense"
                                ...
                                @can('expense.expense_categories.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'expense-cateogry' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('ExpenseCategoryController@create') }}">{{ __('lang.add_expense_category') }}</a>
                                    </li>
                                @endcan
                                @can('expense.expense_categories.view')
                                    <li class="@if (request()->segment(1) == 'expense-cateogry' && empty(request()->segment(2))) active @endif">
                                        <a
                                ...
                                @can('expense.expense_beneficiaries.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'expense-beneficiary' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('ExpenseBeneficiaryController@create') }}">{{ __('lang.add_expense_beneficiary') }}</a>
                                    </li>
                                @endcan
                                @can('expense.expense_beneficiaries.view')
                                    <li class="@if (request()->segment(1) == 'expense-beneficiary' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('ExpenseBeneficiaryController@index') }}">{{ __('lang.view_expense_beneficiaries') }}</a>
                                    </li>
                                @endcan
                                @can('expense.expense_beneficiaries.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'expense' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('ExpenseController@create') }}">{{ __('lang.add_new_expense') }}</a>
                                    </li>
                                @endcan
                                @can('expense.expense_beneficiaries.view')
                                    <li class="@if (request()->segment(1) == 'expense' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('ExpenseController@index') }}">{{ __('lang.view_all_expenses') }}</a>
                                    </li>
                                @endcan
                ...
                @if (!empty($module_settings['cash']))
                    @if (auth()->user()->can('cash.add_cash.create_and_edit') ||
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#cash" aria-expanded="false"
                            ...
                            <ul id="cash"
                                ...
                                @can('cash.add_cash_in.view')
                                    <li class="@if (request()->segment(1) == 'cash-in' && empty(request()->segment(2))) active @endif">
                                        <a href="{{ action('CashInController@index') }}">{{ __('lang.cash_in') }}</a>
                                    </li>
                                @endcan
                                @can('cash.add_cash_out.view')
                                    <li class="@if (request()->segment(1) == 'cash-out' && empty(request()->segment(2))) active @endif">
                ...
                @if (!empty($module_settings['adjustment']))
                    @if (auth()->user()->can('adjustment.cash_in_adjustment.create_and_edit') ||
                            auth()->user()->can('adjustment.cash_in_adjustment.view'))
                        <li class="side_main_menu_link"><a class="link" href="#adjustment" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="adjustment"
                                class="collapse list-unstyled @if (in_array(request()->segment(1), [
                                        ...
                                        'customer-point-adjustment',
                                    ])) show @endif">
                                @can('adjustment.cash_in_adjustment.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'cash-in-adjustment' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('CashInAdjustmentController@create') }}">{{ __('lang.add_cash_in_adjustment') }}</a>
                                    </li>
                                @endcan
                                @can('adjustment.cash_in_adjustment.view')
                                    <li class="@if (request()->segment(1) == 'cash-in-adjustment' && empty(request()->segment(2))) active @endif">
                                        <a
                                ...
                                @can('adjustment.cash_out_adjustment.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'cash-out-adjustment' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('CashOutAdjustmentController@create') }}">{{ __('lang.add_cash_out_adjustment') }}</a>
                                    </li>
                                @endcan
                                @can('adjustment.cash_out_adjustment.view')
                                    <li class="@if (request()->segment(1) == 'cash-out-adjustment' && empty(request()->segment(2))) active @endif">
                                        <a
                                ...
                                @can('adjustment.customer_balance_adjustment.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'customer-balance-adjustment' && request()->segment(2) == 'create') active @endif">
                                        <a
                                ...
                                @can('adjustment.customer_balance_adjustment.view')
                                    <li class="@if (request()->segment(1) == 'customer-balance-adjustment' && empty(request()->segment(2))) active @endif">
                                        <a
                                ...
                                @can('adjustment.customer_point_adjustment.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'customer-point-adjustment' && request()->segment(2) == 'create') active @endif">
                                        <a
                                ...
                                @can('adjustment.customer_point_adjustment.view')
                                    <li class="@if (request()->segment(1) == 'customer-point-adjustment' && empty(request()->segment(2))) active @endif">
                                        <a
                ...
                @if (!empty($module_settings['reports']))
                    @if (auth()->user()->can('reports.profit_loss.view') ||
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#reports" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="reports"
                                ...
                                @can('reports.profit_loss.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-profit-loss') active @endif">
                                        <a
                                            href="{{ action('ReportController@getProfitLoss') }}">{{ __('lang.profit_loss_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.daily_sales_summary.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'daily-sales-summary') active @endif">
                                        <a
                                            href="{{ action('ReportController@getDailySalesSummary') }}">{{ __('lang.daily_sales_summary') }}</a>
                                    </li>
                                @endcan
                                @can('reports.receivable_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-receivable-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getReceivableReport') }}">{{ __('lang.receivable_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.payable_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-payable-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getPayableReport') }}">{{ __('lang.payable_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.expected_receivable_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-expected-receivable-report') active @endif">
                                        <a
                                ...
                                @can('reports.expected_payable_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-expected-payable-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getExpectedPayableReport') }}">{{ __('lang.expected_payable_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.summary_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-summary-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getSummaryReport') }}">{{ __('lang.summary_report') }}</a>
                                    </li>
                                @endcan
                                @if (session('system_mode') == 'restaurant')
                                    @can('reports.dining_in_sales.view')
                                        <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-dining-report') active @endif">
                                            <a
                                ...
                                @can('reports.sales_per_employee.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-employee-commission-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getSalesPerEmployeeReport') }}">{{ __('lang.sales_per_employee') }}</a>
                                    </li>
                                @endcan
                                @can('reports.best_seller_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-best-seller-report') active @endif">
                                        <a
                                ...
                                @can('reports.daily_sale_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-daily-sale-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getDailySaleReport') }}">{{ __('lang.daily_sale_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.monthly_sale_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-monthly-sale-report') active @endif">
                                        <a
                                ...
                                @can('reports.daily_purchase_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-daily-purchase-report') active @endif">
                                        <a
                                ...
                                @can('reports.sale_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-sale-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getSaleReport') }}">{{ __('lang.sale_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.payment_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-payment-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getPaymentReport') }}">{{ __('lang.payment_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.purchase_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-purchase-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getPurchaseReport') }}">{{ __('lang.purchase_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.store_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-store-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getStoreReport') }}">{{ __('lang.store_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.store_stock_chart.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-store-stock-chart') active @endif">
                                        <a
                                ...
                                @can('reports.customer_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-customer-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getCustomerReport') }}">{{ __('lang.customer_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.supplier_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-supplier-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getSupplierReport') }}">{{ __('lang.supplier_report') }}</a>
                                    </li>
                                @endcan
                                @can('reports.due_report.view')
                                    <li class="@if (request()->segment(1) == 'report' && request()->segment(2) == 'get-due-report') active @endif">
                                        <a
                                            href="{{ action('ReportController@getDueReport') }}">{{ __('lang.due_report') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                ...
                @if (!empty($module_settings['coupons_and_gift_cards']))
                    @if (auth()->user()->can('coupons_and_gift_cards.coupon.create_and_edit') ||
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#coupons_and_gift_cards"
                                aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="coupons_and_gift_cards"
                                ...
                                @can('coupons_and_gift_cards.coupon.view')
                                    <li class="@if (request()->segment(1) == 'coupon' && request()->segment(2) == 'create') active @endif">
                                        <a href="{{ action('CouponController@index') }}">{{ __('lang.coupon') }}</a>
                                    </li>
                                @endcan
                                @can('coupons_and_gift_cards.gift_card.view')
                                    <li class="@if (request()->segment(1) == 'gift-card' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('GiftCardController@index') }}">{{ __('lang.gift_card') }}</a>
                                    </li>
                                @endcan
                ...
                @if (!empty($module_settings['customer_module']))
                    @if (auth()->user()->can('customer_module.customer.create_and_edit') ||
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#customer" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="customer"
                                ...
                                @can('customer_module.customer.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'customer' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('CustomerController@create') }}">{{ __('lang.add_new_customer') }}</a>
                                    </li>
                                @endcan
                                @can('customer_module.customer.view')
                                    <li class="@if (request()->segment(1) == 'customer' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('CustomerController@index') }}">{{ __('lang.view_all_customer') }}</a>
                                    </li>
                                @endcan
                                @can('customer_module.customer_type.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'customer-type' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('CustomerTypeController@create') }}">{{ __('lang.add_new_customer_type') }}</a>
                                    </li>
                                @endcan
                                @can('customer_module.customer_type.view')
                                    <li class="@if (request()->segment(1) == 'customer-type' && empty(request()->segment(2))) active @endif">
                                        <a
                ...
                @if (!empty($module_settings['supplier_module']))
                    @if (auth()->user()->can('supplier_module.supplier.create_and_edit') ||
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#supplier" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="supplier"
                                ...
                                @can('supplier_module.supplier.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'supplier' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('SupplierController@create') }}">{{ __('lang.add_new_supplier') }}</a>
                                    </li>
                                @endcan
                                @can('supplier_module.supplier.view')
                                    <li class="@if (request()->segment(1) == 'supplier' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('SupplierController@index') }}">{{ __('lang.view_all_supplier') }}</a>
                                    </li>
                                @endcan
                ...
                @if (!empty($module_settings['sp_module']))
                    @if (auth()->user()->can('sp_module.sales_promotion.create_and_edit') ||
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#sales_promotion"
                                aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="sales_promotion"
                                ...
                                @can('sp_module.sales_promotion.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'sales-promotion' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('SalesPromotionController@create') }}">{{ __('lang.add_new_sales_promotion') }}</a>
                                    </li>
                                @endcan
                                @can('sp_module.sales_promotion.view')
                                    <li class="@if (request()->segment(1) == 'sales-promotion' && empty(request()->segment(2))) active @endif">
                                        <a
                ...
                @if (!empty($module_settings['hr_management']))
                    ...
                    @if (auth()->user()->can('hr_management.add_new_employee.view') ||
                        ...
                        <li class="side_main_menu_link">
                            <a class="link" href="#hrm" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul class="list-unstyled collapse @if (request()->segment(1) == 'hrm' &&
                                ...
                                @can('hr_management.leave_types.view')
                                    <li class="@if (request()->segment(2) == 'leave-type' && empty(request()->segment(3))) active @endif">
                                ...
                                @can('hr_management.forfeit_leaves.view')
                                    <li class="@if (request()->segment(2) == 'forfeit-leaves' && empty(request()->segment(3))) active @endif">
                                        <a href="{{ action('ForfeitLeaveController@index') }}">@lang('lang.view_list_of_employees_in_forfeit_leave')</a>
                                    </li>
                                @endcan
                                @can('hr_management.attendance.create_and_edit')
                                    <li class="@if (request()->segment(2) == 'attendance' && request()->segment(3) == 'create') active @endif">
                                        <a href="{{ action('AttendanceController@create') }}">@lang('lang.attendance')</a>
                                    </li>
                                @endcan
                                @can('hr_management.attendance.view')
                                    <li class="@if (request()->segment(2) == 'attendance' && empty(request()->segment(3))) active @endif">
                                ...
                                @can('hr_management.wages_and_compensation.create_and_edit')
                                    <li class="@if (request()->segment(2) == 'wages-and-compensations' && request()->segment(3) == 'create') active @endif">
                                        <a
                                ...
                                @can('hr_management.wages_and_compensation.view')
                                    <li class="@if (request()->segment(2) == 'wages-and-compensations' && empty(request()->segment(3))) active @endif">
                                        <a
                ...
                @if (!empty($module_settings['loyalty_points']))
                    @if (auth()->user()->can('loyalty_points.earning_of_points.create_and_edit') ||
                        ...
                        <li class="side_main_menu_link"><a class="link" href="#loyalty_points"
                                aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="loyalty_points"
                                ...
                                @can('loyalty_points.earning_of_points.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'earning-of-points' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('EarningOfPointController@create') }}">{{ __('lang.earning_of_point_system') }}</a>
                                    </li>
                                @endcan
                                @can('loyalty_points.earning_of_points.view')
                                    <li class="@if (request()->segment(1) == 'earning-of-points' && empty(request()->segment(2))) active @endif">
                                        <a
                                ...
                                @can('loyalty_points.redemption_of_points.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'redemption-of-points' && request()->segment(2) == 'create') active @endif">
                                        <a
                                ...
                                @can('loyalty_points.redemption_of_points.view')
                                    <li class="@if (request()->segment(1) == 'redemption-of-points' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('RedemptionOfPointController@index') }}">{{ __('lang.list_redemption_of_points_system') }}</a>
                                    </li>
                                @endcan
                                @can('loyalty_points.earning_of_points.view')
                                    <li class="@if (request()->segment(1) == 'earning-of-points' && request()->segment(2) == 'get-list-of-earned-point') active @endif">
                                        <a
                                            href="{{ action('EarningOfPointController@getListOfEarnedPoint') }}">{{ __('lang.list_of_earn_point_by_transactions') }}</a>
                                    </li>
                                @endcan
                                @can('loyalty_points.earning_of_points.view')
                                    <li class="@if (request()->segment(1) == 'redemption-of-points' && request()->segment(2) == 'get-list-of-redeemed-point') active @endif">
                                        <a
                ...
                @if (!empty($module_settings['safe_module']))
                    @if (auth()->user()->can('safe_module.money_safe.create_and_edit') || auth()->user()->can('safe_module.money_safe.view'))
                        <li class="side_main_menu_link"><a class="link" href="#money_safe" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="money_safe"
                                ...
                                @can('safe_module.money_safe.view')
                                    <li class="@if (request()->segment(1) == 'money-safe' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('MoneySafeController@index') }}">{{ __('lang.view_all_money_safe') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                ...
                @if (!empty($module_settings['sms_module']))
                    @if (auth()->user()->can('sms_module.sms.create_and_edit') || auth()->user()->can('sms_module.sms.view'))
                        <li class="side_main_menu_link"><a class="link" href="#sms" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="sms"
                                ...
                                @can('sms_module.sms.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'sms' && request()->segment(2) == 'create') active @endif">
                                ...
                                @can('sms_module.setting.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'sms' && request()->segment(2) == 'setting') active @endif">
                                        <a
                                            href="{{ action('SmsController@getSetting') }}">{{ __('lang.settings') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                ...
                @if (!empty($module_settings['email_module']))
                    @if (auth()->user()->can('email_module.email.create_and_edit') || auth()->user()->can('email_module.email.view'))
                        <li class="side_main_menu_link"><a class="link" href="#email" aria-expanded="false"
                                data-toggle="collapse"> <i
                            ...
                            <ul id="email"
                                ...
                                @can('email_module.email.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'email' && request()->segment(2) == 'create') active @endif">
                                        <a
                                            href="{{ action('EmailController@create') }}">{{ __('lang.send_email') }}</a>
                                    </li>
                                @endcan
                                @can('email_module.email.view')
                                    <li class="@if (request()->segment(1) == 'email' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('EmailController@index') }}">{{ __('lang.view_all_emails') }}</a>
                                    </li>
                                @endcan
                                @can('email_module.setting.create_and_edit')
                                    <li class="@if (request()->segment(1) == 'email' && request()->segment(2) == 'setting') active @endif">
                                        <a
                                            href="{{ action('EmailController@getSetting') }}">{{ __('lang.settings') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                ...
                @if (!empty($module_settings['settings']))
                    <li class="side_main_menu_link"><a class="link" href="#setting" aria-expanded="false"
                            data-toggle="collapse"> <i class="dripicons-gear"></i><span>@lang('lang.settings')</span></a>
                        <ul id="setting"
                            class="collapse list-unstyled @if (in_array(request()->segment(1), [
                                    'store',
                                    'store-pos',
                            ...
                            @if (session('system_mode') != 'restaurant')
                                @can('product_module.category.view')
                                    <li class="@if (request()->segment(1) == 'category' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('CategoryController@index') }}">{{ __('lang.category') }}</a>
                                    </li>
                                @endcan
                                @can('product_module.sub_category.view')
                                    <li class="@if (request()->segment(1) == 'sub-category' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('CategoryController@getSubCategories') }}">{{ __('lang.sub_category') }}</a>
                                    </li>
                                @endcan
                            @endif
                            ...
                            @if (session('system_mode') == 'restaurant')
                                @can('settings.service_fee.view')
                                    <li class="@if (request()->segment(1) == 'service-fee' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('ServiceFeeController@index') }}">{{ __('lang.service_fee') }}</a>
                                    </li>
                                @endcan
                                @can('settings.dining_room.view')
                                    <li class="@if (request()->segment(1) == 'dining-room' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('DiningRoomController@index') }}">{{ __('lang.dining_room') }}</a>
                                    </li>
                                @endcan
                                @can('settings.dining_table.view')
                                    <li class="@if (request()->segment(1) == 'dining-table' && empty(request()->segment(2))) active @endif">
                                        <a
                                            href="{{ action('DiningTableController@index') }}">{{ __('lang.dining_table') }}</a>
                                    </li>
                                @endcan
                            @endif
                            @can('settings.delivery_zone.view')
                                <li class="@if (request()->segment(1) == 'delivery-zone' && empty(request()->segment(2))) active @endif">
                                    <a
                                        href="{{ action('DeliveryZoneController@index') }}">{{ __('lang.delivery_zone') }}</a>
                                </li>
                            @endcan
                            @can('settings.exchange_rate.view')
                                <li class="@if (request()->segment(1) == 'exchange-rate' && empty(request()->segment(2))) active @endif">
                                    <a
                                        href="{{ action('ExchangeRateController@index') }}">{{ __('lang.exchange_rate') }}</a>
                                </li>
                            @endcan
                            @can('product_module.tax.view')
                                <li class="@if (request()->segment(1) == 'tax' && empty(request()->segment(2)) && request()->type == 'product_tax') active @endif">
                                    <a
                                        href="{{ action('TaxController@index') }}?type=product_tax">{{ __('lang.product_tax') }}</a>
                                </li>
                            @endcan
                            @can('product_module.tax.view')
                                <li class="@if (request()->segment(1) == 'tax' && empty(request()->segment(2)) && request()->type == 'general_tax') active @endif">
                                    <a
                                        href="{{ action('TaxController@index') }}?type=general_tax">{{ __('lang.general_tax') }}</a>
                                </li>
                            @endcan
                            ...
                            @can('settings.store_pos.view')
                                <li class="@if (request()->segment(1) == 'store-pos' && empty(request()->segment(2))) active @endif">
                                    <a
                                        href="{{ action('StorePosController@index') }}">{{ __('lang.pos_for_the_stores') }}</a>
                                </li>
                            @endcan
                            @can('settings.terms_and_conditions.view')
                                <li class="@if (request()->segment(1) == 'terms-and-conditions' && request()->type == 'invoice') ) active @endif">
                                    <a
                            ...
                            @can('settings.terms_and_conditions.view')
                                <li class="@if (request()->segment(1) == 'terms-and-conditions' && request()->type == 'quotation') ) active @endif">
                                    <a
                            ...
                            @can('settings.modules.create_and_edit')
                                <li class="@if (request()->segment(1) == 'settings' && request()->segment(2) == 'modules') active @endif">
                                    <a
                                        href="{{ action('SettingController@getModuleSettings') }}">{{ __('lang.modules') }}</a>
                                </li>
                            @endcan
                            @can('settings.weighing_scale_setting.create_and_edit')
                                <li class="@if (request()->segment(1) == 'settings' && request()->segment(2) == 'get-weighing-scale-setting') active @endif">
                                    <a
                                        href="{{ action('SettingController@getWeighingScaleSetting') }}">{{ __('lang.weighing_scale_setting') }}</a>
                                </li>
                            @endcan
                            @can('settings.general_settings.view')
                                <li class="@if (request()->segment(1) == 'settings' && request()->segment(2) == 'get-general-setting') active @endif">
                                    <a
