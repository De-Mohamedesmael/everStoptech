            ...
            <div class="row">
                <div class="col-md-12 px-1">
                    <div
                        ...
                        <h5 class="mb-0 position-relative" style="margin-right: 30px">@lang('lang.add_sales_promotion_formal_discount')
                    ...
                    {!! Form::open([
                        'url' => action('SalesPromotionController@store'),
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('purchase_condition_amount', 0, [
                                            'class' => 'form-control modal-input app()->isLocale("ar") ? text-end : text-start',
                                        ]) !!}
                                    </div>
                                </div>
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('discount_type', ['fixed' => 'Fixed', 'percentage' => 'Percentage'], false, [
                                ...
                                <div class="col-md-2 d-flex justify-content-center align-items-center">
                                    <label for="" class="new_price hide">@lang('lang.new_price'):
