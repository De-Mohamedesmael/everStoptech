        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 px-1">
                    ...
                    {!! Form::open([
                        'url' => action('PurchaseReturnController@update', $purchase_return->id),
                        'method' => 'put',
                        'files' => true,
                        'class' => 'pos-form',
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('supplier_id', $suppliers, $purchase_return->supplier_id, [
                                            'class' => 'form-control',
                                ...
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('store_id', $stores, $purchase_return->store_id, [
                                            'class' => 'form-control',
                                            'data-live-search' => 'true',
                                            'placeholder' => __('lang.please_select'),
                                            'required',
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table id="product_table" style="width: 100% " class="table table-striped">
                                            ...
                                            <tbody>
                                                @include('purchase_return.partials.edit_product_row', [
                                                    'products_' => $purchase_return->purchase_return_lines,
                                                ])
                                            </tbody>
                                            <tfoot>
                                                <tr>
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('payment_status', $payment_status_array, $purchase_return->payment_status, [
                                            'class' => 'form-control',
                                            'placeholder' => __('lang.please_select'),
                                            'required',
                                        ]) !!}
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                ...
                                <div class="col-md-3 due_fields hide">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('notify_before_days', !empty($purchase_return) ? $purchase_return->notify_before_days : null, [
