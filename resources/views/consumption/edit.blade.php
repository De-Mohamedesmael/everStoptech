        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 px-1">
                    ...
                    {!! Form::open([
                        'url' => action('ConsumptionController@update', $consumption->id),
                        'id' => 'consumption-form',
                        'method' => 'PUT',
                        'class' => '',
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('store_id', $stores, $consumption->store_id, [
                                ...
                                <div class="col-md-3 px-5 @if (!auth()->user()->can('raw_material_module.add_consumption_for_others.create_and_edit')) hide @endif">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('created_by', $chefs, $consumption->created_by, [
                                            'class' => 'selectpicker form-control',
                                            'data-live-search' => 'true',
                                            'required',
                                            'style' => 'width: 80%',
                    ...
                    <div class="card mb-2">
                        <div class="card-body p-2">
                            <table class="table table-bordered" id="consumption_table">
                                ...
                                <tbody>
                                    @include('consumption.partial.consumption_row', [
                                        'row_id' => 0,
