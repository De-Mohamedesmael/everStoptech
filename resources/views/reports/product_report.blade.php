            ...
            <div class="row">
                <div class="col-md-12 px-1  no-print">
                    <div
                        ...
                        {{-- <h5 class="mb-0 print-title-hint position-relative" style="margin-right: 30px">
                            product_report
                            <span class="header-pill"></span>
                        </h5> --}}
                    </div>
                                ...
                                <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                    ...
                                    <div class="col-md-3 px-5 d-flex justify-content-center align-items-center">
                                        <a href="{{ action('ReportController@getCategoryPurchases') }}"
                                            class="btn btn-primary col-md-12">@lang('lang.category_purchases')</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        $employee = App\Models\Employee::whereJsonContains(
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        if (!empty($employee_id)) {
                                                            $commission = App\Models\Transaction::leftjoin(
                                                                'transaction_sell_lines',
                                                                'transactions.parent_sale_id',
                                                                ...
                                                                ->select(
                                                                    DB::raw(
                                                                        'SUM(transactions.final_total) as commission',
                                                                    ),
                                                                )
                                                                ->first();
                                                        }
