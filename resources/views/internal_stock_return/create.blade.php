            ...
            <div class="row">
                <div class="col-md-12 px-1">
                    <div
                        ...
                        <h5 class="mb-0 position-relative print-title" style="margin-right: 30px">@lang('lang.internal_stock_return')
                            <span class="header-pill"></span>
                        </h5>
                    </div>
                    {!! Form::open([
                        'url' => action('InternalStockReturnController@store'),
                        'method' => 'post',
                        'id' => 'internal_stock_return_form',
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('sender_store_id', $stores, session('user.store_id'), [
                    ...
                    <div class="card my-3">
                        <div class="card-body p-2">
                            <div class="mb-3 d-flex flex-wrap @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"
                                style="gap:7px">
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-3 d-flex justify-content-center">
                                    <h4
                                        ...
                                        <span
                                            class="count_value_style col-md-6 final_total_span">{{ 0 }}</span>
                                    </h4>
                                </div>
                            </div>
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::file('files[]', null, ['class' => ' modal-input app()->isLocale("ar") ? text-end : text-start']) !!}
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="col-md-4 d-flex justify-content-between px-5">
                                    <button type="submit" name="submit" id="save" value="save"
                                        class="btn btn-main col-md-12 submit">@lang('lang.request_a_return')</button>
                                </div>
                                <div class="col-md-4 d-flex justify-content-between px-5">
                                    <a href="{{ action('InternalStockReturnController@create') }}"
                                        class="btn btn-danger col-md-12">@lang('lang.cancel')</a>
                                </div>
                            </div>
