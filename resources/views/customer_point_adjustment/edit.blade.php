                ...
                <div class="col-md-12 px-1">
                    <div
                        ...
                        <h5 class="mb-0 position-relative" style="margin-right: 30px">
                            @lang('lang.customer_point_adjustment')
                            <span class="header-pill"></span>
                        </h5>
                    </div>
                    {!! Form::open([
                        'url' => action('CustomerPointAdjustmentController@update', $customer_point_adjustment->id),
                        'method' => 'put',
                        'id' => 'sms_form',
                        'files' => true,
                    ]) !!}
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('store_id', $stores, $customer_point_adjustment->store_id, [
                                            'class' => 'form-control
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                selectpicker',
                                            'id' => 'store_id',
                                ...
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('current_balance', @num_format($customer_point_adjustment->current_balance), [
                                ...
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('add_new_balance', @num_format($customer_point_adjustment->add_new_balance), [
                                            'class' => 'form-control modal-input app()->isLocale("ar") ? text-end : text-start',
                                            'id' => 'add_new_balance',
                                ...
                                <div class="col-md-12 px-5">
                                    ...
                                    {!! Form::textarea('notes', $customer_point_adjustment->notes, [
                                        'class' => 'form-control modal-input app()->isLocale("ar") ? text-end : text-start',
                                        'rows' => 3,
                                    ]) !!}
                                </div>
...
@section('javascript')
    <script type="text/javascript">
        ...
        $(document).on('change', '#admin_id', function() {
            ...
            $.ajax({
                method: 'get',
                url: '/cash-in-adjustment/get-cash-details/' + admin_id,
                data: {},
