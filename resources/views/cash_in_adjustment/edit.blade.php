        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 px-1">
                    ...
                    {!! Form::open([
                        'url' => action('CashInAdjustmentController@update', $cash_in_adjustment->id),
                        'method' => 'put',
                        'id' => 'sms_form',
                        'files' => true,
                    ]) !!}
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('store_id', $stores, $cash_in_adjustment->store_id, [
                                            'class' => 'form-control
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        selectpicker',
                                            'id' => 'store_id',
                                ...
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('admin_id', $admins, $cash_in_adjustment->admin_id, [
                                            'class' => 'form-control
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        selectpicker',
                                            'id' => 'admin_id',
                                            'placeholder' => __('lang.please_select'),
                                ...
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('amount', @num_format($cash_in_adjustment->amount), [
                                            'class' => 'form-control modal-input app()->isLocale("ar") ? text-end : text-start',
                                            'id' => 'amount',
