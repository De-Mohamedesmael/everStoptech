        ...
        <div class="container-fluid">
                ...
                <div class="card-body p-2">
                    <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                        ...
                        <div class="col-md-3 px-5 d-flex justify-content-center align-items-center">
                            <div class="form-group d-flex px-0 col-12">
                                {{-- <label>
                                Don't show zero stocks
                            </label> --}}
                                {!! Form::label('show_zero_stocks', "Don't show zero stocks", [
                                    'class' => 'form-label col-md-11 d-block mb-1 app()->isLocale("ar") ? text-end : text-start',
                                ]) !!}
                                {!! Form::checkbox(
                                    'show_zero_stocks',
                                    1,
                                    false,
                                    ['class' => ' form-control col-md-1  show_zero_stocks', 'data-live-search' => 'true'],
            ...
            <div class="card mb-2">
                <div class="card-body p-2">
                    <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"
                        ...
                        <button type="button" value="15" class="select_product_button column-toggle">
                            @if (session('system_mode') == 'restaurant')
                                @lang('lang.category')
                            @else
                                @lang('lang.class')
                    ...
                    class="select_product_button column-toggle">@lang('lang.avg_purchase_price')</button> --}}
                        @endcan
            ...
            <div class="card mb-2 d-flex flex-row justify-content-center align-items-center">
                <p class="italic mb-0 py-1">
                    <small>@lang('lang.check_purchase_price_please')</small>
            ...
            <input type="hidden" id="des"
                value="{{ \App\Models\System::getProperty('numbers_length_after_dot') }}" />
            ...
            <button data-check_password="{{ action('AdminController@checkAdminPassword', 2) }}"
            ...
            product_table = $('#product_table').DataTable({
                ...
                columns: [{
                        ...
                        'render': function(data, type, val, meta) {
                            return '<span hidden type="text" readonly="readonly" class="pro_id" name="product_id" />' +
                                data + '</span>';
                        },
                        // visible: false
                        sortable: false,
                    },
                    {
                        data: 'variation_id',
                        'render': function(data, type, val, meta) {
                            return '<span hidden type="text" readonly="readonly" class="variation_id" name="variation_id" />' +
                                data + '</span>';
                        },
                        // visible: false
                        searchable: false,
                    ...
                    },
                    {
                        ...
                        name: 'current_stock',
                        'render': function(data, type, val, meta) {
                            return '<span type="text" readonly="readonly" class="current_stock" name="current_stock" />' +
                                data + '</span> ' +
                                '<input type="hidden"  class="current_stock_hidden"  value="' +
                                data + '">';
                        },
                    ...
                    @can('product_module.purchase_price.view')
                        {
                            ...
                            'render': function(data, type, val, meta) {
                                return '<span type="text" readonly="readonly" class="avg_purchase_price" name="avg_purchase_price" />' +
                                    data + '</span>';
                            },
...

                        {
                            ...
                            'render': function(data, type, val, meta) {
                                return '<input type="text" class="default_purchase_price" name="default_purchase_price"  value="' +
                                    data + '">';
                            },
                            searchable: false
                        }, {
                            ...
                            // className: "default_purchase_price",
                            'render': function(data, type, val, meta) {
                                return '<input hidden type="text" class="hidden_default_purchase_price"  value="' +
                                    data + '">';
                            },
                            searchable: false,
                            // visible : false,
                    ...
                    @endcan {
                        ...
                        'render': function(data, type, val, meta) {
                            return '<input type="text" class="default_sell_price" name="default_sell_price"  value="' +
                                data + '">';
                        },
                    },
                    {
                        ...
                        // className: "default_purchase_price",
                        'render': function(data, type, val, meta) {
                            return '<input hidden type="text" class="hidden_default_sell_price"  value="' +
                                data + '">';
                        },
                        searchable: false,
                        // visible : false,
        ...
        $(document).ready(function() {
            ...
            $('#product_table').on('change', '.default_purchase_price, .default_sell_price', function() {
                ...
                if (purchasePrice >= sellPrice) {
                    ...
                    row.find('.default_sell_price').css('border',
                        ''); // Reset border if condition is not met
                }
            });
