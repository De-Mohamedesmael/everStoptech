    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                @include('back-end.sales.pos.partials.payment_modal')
                @include('back-end.sales.pos.partials.discount_modal')
                {{-- @include('back-end.sales.pos.partials.tax_modal') --}}
                @include('back-end.sales.pos.partials.coupon_modal')
                @include('back-end.sales.pos.partials.contact_details_modal')
                @include('back-end.sales.pos.partials.weighing_scale_modal')
                @include('back-end.sales.pos.partials.non_identifiable_item_modal')
                @include('back-end.sales.pos.partials.sale_note')
                ...
                <div
                    ...
                    @include('back-end.sales.pos.partials.right_side')
                </div>
                    ...
                    <div class="modal-dialog modal-xl" role="document" style="min-width: 95%;">
                        <div class="modal-content">
                            ...
                            <div class="modal-body ">
                                ...
                                <div class="col-md-12">
                                    @include('back-end.sales.pos.partials.recent_transactions')
                                </div>
                            </div>
                    ...
                    <div class="modal-dialog" role="document" style="min-width: 95%;">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-md-12">
                                    @include('back-end.sales.pos.partials.view_draft')
                                </div>
                            </div>
