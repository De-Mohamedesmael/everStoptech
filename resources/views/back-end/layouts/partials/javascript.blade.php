...
<script type="text/javascript" src="{{ asset('assets/back-end/js/jquery-validation/jquery.validate.min.js') }}"></script>
<script type="text/javascript"
        ...
        Swal.fire({
            ...
            if (willDelete) {
                ...
                Swal.fire({
                    ...
                    if (result) {
                        $.ajax({
                            url: '{{ route('admin.checkPassword',auth()->guard('admin')->id()) }}',
                            method: 'POST',
                            data: {
                                value: result,
                            },
