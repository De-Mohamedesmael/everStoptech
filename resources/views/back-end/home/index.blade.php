                ...
                <div class="row justify-content-evenly  item-list-a">
                    ...
                    <div class="card-deck home-card-deck col-6 col-md-4 col-lg-2 animate__animated  animate__bounceIn"
                        ...
                        <a href="#">
                            <div class="card home-card-deck p-3">
                                <img class="card-img-top" src="{{ asset('assets/back-end/images/dashboard-icon/dashboard (1).png') }}"
                                     alt="Card image cap">
                    ...
                    <div class="card-deck home-card-deck col-6 col-md-4 col-lg-2 animate__animated  animate__bounceIn"
                        ...
                        <a href={{-- route('products.create') --}}>
                            <div class="card p-3">
                                <img class="card-img-top" src="{{ asset('assets/back-end/images/dashboard-icon/dairy-products.png') }}"
                                     alt="Card image cap">
                                <div class="card-body pt-2 p-0 text-center">
                    ...
                    <div class="card-deck home-card-deck col-6 col-md-4 col-lg-2 animate__animated  animate__bounceIn"
                        ...
                        <a href="{{-- route('pos.index') --}}">
                            <div class="card p-3">
                                <img class="card-img-top" src="{{ asset('assets/back-end/images/dashboard-icon/cash-machine.png') }}"
                                     alt="Card image cap">
                                <div class="card-body pt-2 p-0 text-center">
                                    <a class="font-weight-bold text-decoration-none card-title font-16"
                    ...
                    <div class="card-deck home-card-deck col-6 col-md-4 col-lg-2 animate__animated  animate__bounceIn"
                        ...
                        <a href="{{-- route('stocks.create') --}}">
                            <div class="card p-3">
                                <img class="card-img-top" src="{{ asset('assets/back-end/images/dashboard-icon/warehouse.png') }}"
                                     alt="Card image cap">
                                <div class="card-body pt-2 p-0 text-center">
                                    <a class="font-weight-bold text-decoration-none card-title font-16"
                    ...
                    <div class="card-deck home-card-deck col-6 col-md-4 col-lg-2 animate__animated  animate__bounceIn"
                        ...
                        <a href="{{--route('returns') --}}">
                            <div class="card p-3">
                                <img class="card-img-top" src="{{ asset('assets/back-end/images/dashboard-icon/return.png') }}"
                                     alt="Card image cap">
                                <div class="card-body pt-2 p-0 text-center">
                                    <a class="font-weight-bold text-decoration-none card-title font-16"
                    ...
                    <div class="card-deck home-card-deck col-6 col-md-4 col-lg-2 animate__animated  animate__bounceIn"
                        ...
                        <a href="{{-- route('employees.create') --}}">
                            <div class="card p-3">
                                <img class="card-img-top" src="{{ asset('assets/back-end/images/dashboard-icon/employment.png') }}"
                                     alt="Card image cap">
                                <div class="card-body pt-2 p-0 text-center">
                                    <a class="font-weight-bold text-decoration-none card-title font-16"
                    ...
                    <div class="card-deck home-card-deck col-6 col-md-4 col-lg-2 animate__animated  animate__bounceIn"
                        ...
                        <a href="{{-- route('customers.create') --}}">
                            <div class="card p-3">
                                <img class="card-img-top" src="{{ asset('assets/back-end/images/dashboard-icon/customer-satisfaction.png') }}"
                                     alt="Card image cap">
                                <div class="card-body pt-2 p-0 text-center ">
                                    <a class="font-weight-bold text-decoration-none card-title font-16"
...
{{--                    </div>--}}
                    ...
                    <div class="card-deck home-card-deck col-6 col-md-4 col-lg-2 animate__animated  animate__bounceIn"
                        ...
                        <a href="#">
                            <div class="card p-3">
                                <img class="card-img-top" src="{{ asset('assets/back-end/images/dashboard-icon/settings.png') }}"
                                     alt="Card image cap">
                                <div class="card-body pt-2 p-0 text-center">
                                    <a class="font-weight-bold text-decoration-none card-title font-16"
                                    >{{ __('lang.settings') }}</a>
                    ...
                    <div class="card-deck home-card-deck col-6 col-md-4 col-lg-2 animate__animated  animate__bounceIn align-content-center"
                        ...
                        <a href="#">
                            <div class="card p-3">
                                <img class="card-img-top" src="{{ asset('assets/back-end/images/dashboard-icon/report.png') }}"
                                     alt="Card image cap">
                                <div class="card-body pt-2 p-0 text-center">
