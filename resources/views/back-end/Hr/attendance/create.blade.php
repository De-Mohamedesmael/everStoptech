...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item @if (app()->isLocale('ar')) mr-2 @else ml-2 @endif active" aria-current="page">
        <a style="text-decoration: none;color: #1565c0" href="{{ action('AttendanceController@index') }}">/@lang('lang.attendance')</a></li>
    <li class="breadcrumb-item @if (app()->isLocale('ar')) mr-2 @else ml-2 @endif active" aria-current="page">
                        ...
                        <div class="col-sm-12">
                            ...
                            <table class="table table_tbody" id="attendance_table">
                                ...
                                <tbody>
                                    ...
                                    @include('back-end.Hr.attendance.partials.attendance_row',["row_index"=>0])
