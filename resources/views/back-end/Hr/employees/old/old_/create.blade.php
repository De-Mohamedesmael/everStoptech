...
@section('button')
    <div class="widgetbar  d-flex @if (app()->isLocale('ar')) justify-content-start @else justify-content-end @endif">
        <a class="btn btn-primary" href="{{ action('EmployeeController@index') }}">@lang('lang.employee')</a>
    </div>
@endsection
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <form class="form-group" id="productForm" action="{{ action('EmployeeController@store') }}"
