            ...
            <div class="col-md-8 col-lg-8">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('products.index') }}">@lang('lang.products_')</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-3" data-key="0">
                                ...
                                <div class="d-flex justify-content-center">
                                    {!! Form::select('products_[0][category_id]', $categories1, $product->category_id ?? null, [
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="d-flex justify-content-center">
                                    {!! Form::select('products_[0][subcategory_id1]', $categories2,  $product->subcategory_id1 ?? null, [
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="d-flex justify-content-center">
                                    {!! Form::select('products_[0][subcategory_id2]', $categories3, $product->subcategory_id2 ?? null, [
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="d-flex justify-content-center">
                                    {!! Form::select('products_[0][subcategory_id3]', $categories4, $product->subcategory_id3 ?? null, [
                                ...
                                <div class="row">
                                    ...
                                    @if($index == 0 )
                                        <div class="col-md-2 pl-5">
                                            {!! Form::label('sku', __('lang.product_code'),['class'=>'h5 pt-3']) !!}
                                            {!! Form::text('products_[0][variations][0][sku]',$variation->sku ?? null, [
                                                'class' => 'form-control'
                                            ]) !!}
                                            <br>
                                            @error('sku.0')
                                            ...
                                            <div class="col-4 offset-1">
                                                <div class="preview-image-container">
                                                    @if (!empty($product->image))
                                                        <div class="preview">
                                                            <img src="{{ asset('uploads/products_/' . $product->image) }}"
                                                                id="image_footer" alt="">
                                                            <button type="button"
