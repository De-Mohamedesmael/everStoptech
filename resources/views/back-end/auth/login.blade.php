                    ...
                    <form class="login" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="login__field">
                            ...
                            <input name="email" id="email" type="email"
                                   ...
                                   placeholder="{{ translate('E-Mail Address') }}" value="{{ old('email') }}" required autofocus>
                            @if ($errors->has('email'))
                        ...
                        <a href="{{ route('password.request') }}" style="font-size: 11px" class=" forgot-password text-muted"><i
                                    class="mdi mdi-lock me-1"></i>
                            {{ translate('forgot_password') }}</a>
                        <p class="text-center contact-us-a">
                            <a href="{{ action('ContactUsController@getContactUs') }}">
