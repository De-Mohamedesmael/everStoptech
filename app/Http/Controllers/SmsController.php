...
class SmsController extends Controller
{
    ...
    {
        $sms = Sms::leftjoin('admins', 'sms.created_by', 'admins.id')->select('sms.*', 'admins.name as sent_by')->get();
    ...
    {
        $employees = Employee::leftjoin('admins', 'employees.admin_id', 'admins.id')->select('name', 'mobile')->pluck('name', 'mobile')->toArray();
    ...
    {
        $sms = Sms::find($id);
        $employees = Employee::leftjoin('admins', 'employees.admin_id', 'admins.id')->pluck('employee_name', 'mobile');
