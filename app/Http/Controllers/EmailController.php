...
class EmailController extends Controller
{
    ...
    {
        $emails = Email::leftjoin('admins', 'emails.created_by', 'admins.id')->select('emails.*', 'admins.name as sent_by')->get();
    ...
    {
        $employees = Employee::leftjoin('admins', 'employees.admin_id', 'admins.id')->pluck('name', 'email');
        $email = null;
        if(!empty(request()->employee_id)){
            $employee = Employee::leftjoin('admins', 'employees.admin_id', 'admins.id')->where('employees.id', request()->employee_id)->first();
            if(!empty($employee)){
