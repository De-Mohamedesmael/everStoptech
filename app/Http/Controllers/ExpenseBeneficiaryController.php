...
class ExpenseBeneficiaryController extends Controller
{
   /**
    ...
    {
        $expense_beneficiaries = ExpenseBeneficiary::leftjoin('admins', 'expense_beneficiaries.created_by', 'admins.id')->select('expense_beneficiaries.*', 'admins.name as created_by')->get();
