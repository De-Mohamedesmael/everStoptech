    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if (!empty($request->source_id)) {
                ...
                $cash_register_transaction_in = $this->cashRegisterUtil->updateCashRegisterTransaction($refercene_transaction->id, $register, $amount, 'cash_in', 'debit',  $admin_id, $request->notes, $cash_register_transaction->id);
